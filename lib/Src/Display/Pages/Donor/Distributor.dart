...
class _DistributorState extends State<Distributor> {
  ...
  addDistributorDialog(BuildContext context) {
    showDialog(
        context: context,
  ...
  void saveDistributor() {
    fb
        .addDistributor(_name_controller.value.text,
            _location_controller.value.text, _id_controller.value.text)
        .then((value) {
      if (value) {
        setState(() {
          isLoading = false;
      ...
      child: StreamBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<Event> event) {
          ...
          if (event.hasError ||
            ...
            Map<dynamic, dynamic> distributors = event.data.snapshot.value;
            distributors.forEach((key, value) {
